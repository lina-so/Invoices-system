												    ...
												    <div class="dropdown">
														...
														<div  class="dropdown-menu tx-13">
															...
															data-toggle="modal" href="#modaldemo9" title="حذف"><i
																class="las la-trash"></i> حذف نهائي</a>
															

															<a class="modal-effect dropdown-item" data-effect="effect-scale" 
															data-id="{{$invoice->id}}" 
															data-toggle="modal" href="#modaldemo20" title=""><i></i>إلغاء الارشفة </a>
				...
				<div class="modal" id="modaldemo9">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content modal-content-demo">
							...
							<form action="delete_archive" method="post">
								{{ method_field('delete') }}
								{{ csrf_field() }}
				...
				<div class="modal" id="modaldemo20">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content modal-content-demo">
							...
							<form action="{{route('cancel_archive')}}" method="post">
							    @csrf
								<div class="modal-body">
									<p>هل انت متاكد من إلغاء الارشفة ؟</p><br>
...
<script src="{{URL::asset('assets/plugins/prism/prism.js')}}"></script>
    ...
    <script>
	    ...
	    <script>
        $('#modaldemo20').on('show.bs.modal', function(event) {
            var button = $(event.relatedTarget)
